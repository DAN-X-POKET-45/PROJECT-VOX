...
namespace xdl{
    ...
    /** 
     * @brief The alias for the type std::map<std::string, std::map<std::string, std::map<std::string, std::string>>>
    **/
    typedef std::map<std::string, std::map<std::string, std::map<std::string, std::string>>> xdl_data_map;
    ...
    **/
    ...
    public:
         ...
         **/
        void write(xdl_data_map content);
