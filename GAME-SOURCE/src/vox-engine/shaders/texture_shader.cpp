...
void texture_shader::set_int_uniform(const std::string &name, int value)const{
    glUniform1i(glGetUniformLocation(ID, name.c_str()), value); 
}

//insersor de uniform do tipo float
void texture_shader::set_float_uniform(const std::string &name, float value)const{
